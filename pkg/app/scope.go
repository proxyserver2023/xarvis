...
import (
	...
	mylogger "github.com/alamin-mahamud/xarvis/pkg/logger"
...
type requestScope struct {
	mylogger.Logger           // the logger tagged with the current request information
...
func newRequestScope(now time.Time, logger *logrus.Logger, request *http.Request) RequestScope {
	l := mylogger.NewLogger(logger, logrus.Fields{})
